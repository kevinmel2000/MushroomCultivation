...
public class FragmentF1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.content_f1, parent, false);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        tvAlat = (TextView)view.findViewById(R.id.f1_tv_alatbahan);
        tvCara = (TextView)view.findViewById(R.id.f1_tv_procedure);


        String alat = getResources().getString(R.string.f1_tool);
        tvAlat.setText(Html.fromHtml(alat, null, new MyTagHandler()));
        String langkah = getResources().getString(R.string.f1_procedure);
        tvCara.setText(Html.fromHtml(langkah, null, new MyTagHandler()));

    }

    public void cvClicked(View v){
        if(v.getId() == R.id.cv_f1_alatbahan){
        ...
        if(v.getId() == R.id.cv_f1_procedure){
